...
class BaseTransactionDescriptionFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dealer'                 => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'reseller'               => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ));
    ...
    $this->setValidators(array(
      ...
      'dealer'                 => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'reseller'               => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ));
