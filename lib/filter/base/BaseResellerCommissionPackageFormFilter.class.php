...
/**
 * ResellerCommissionPackage filter form base class.
 *
 * @package    zapnacrm
 * @subpackage filter
 * @author     Your name here
 */
class BaseResellerCommissionPackageFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reseller_commission_package_filters[%s]');
