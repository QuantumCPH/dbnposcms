...
/**
 * ResellerCommissionPackage form base class.
 *
 * @package    zapnacrm
 * @subpackage form
 * @author     Your name here
 */
class BaseResellerCommissionPackageForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                               => new sfValidatorPropelChoice(array('model' => 'ResellerCommissionPackage', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('reseller_commission_package[%s]');
  ...
  {
    return 'ResellerCommissionPackage';
  }
