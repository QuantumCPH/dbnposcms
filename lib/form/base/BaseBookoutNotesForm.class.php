...
class BaseBookoutNotesForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_received'       => new sfWidgetFormInput(),
      'is_synced'         => new sfWidgetFormInput(),
      'shop_responded_at' => new sfWidgetFormInput(),
      'received_quantity' => new sfWidgetFormInput(),
      'reply_comment'     => new sfWidgetFormInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'is_received'       => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'is_synced'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'shop_responded_at' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'received_quantity' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'reply_comment'     => new sfValidatorString(array('max_length' => 255, 'required' => false)),
    ));
