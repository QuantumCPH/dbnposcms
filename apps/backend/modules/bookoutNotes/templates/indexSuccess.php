...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#myTable').dataTable({
            ...
            "bServerSide": true,
          "aaSorting": [[0,"desc"]],
            "sAjaxSource": "<?php echo sfConfig::get('app_web_url') ?>bookout_server_processing.php",
...
<div class="itemslist">
    ...
    <h1 class="items-head list-page"><img src="<?php echo sfConfig::get('app_web_url') . 'images/delivery_notes_title.png' ?>" align="left" />&nbsp;<span>Bookout Notes</span></h1>
</div>
