...
<form method="POST" action="<?php echo url_for('cron_jobs/create')?>" name="" id="cronJobGenerator">
    ...
    <i style="margin-bottom: 5px; display: block;" class="tips">(Ctrl + Click to select multiple entries)</i>
    Cron Type:<select name="cron_type">
        <?php 
                                    ...
                                    <table class="multipleEntries">
                                        <tbody>
                                            <tr>                            
                                                ...
                                                <td> 
                                                    <select class="cron" name="selectMonths[]" size="10" multiple="">
    ...
    <input type="submit" class="btn-u" name="Generate" value="Generate Cron Job">
