...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        var oTable = $('#myTable').dataTable({
            ...
            "bFilter": false,
            "bInfo": true,
            "sAjaxSource": "<?php echo sfConfig::get('app_web_url') ?>server_stock_report.php",
            "sPaginationType": "full_numbers",
            "aLengthMenu": [[10, 25, 50, 100, 250, 500, 1000], [10, 25, 50, 100, 250, 500, 1000]],
            "fnServerParams": function(aoData) {
                aoData.push({"name": "stock_id", "value": $('#stock_id').val()},{"name": "startDate", "value": $('#startDate').val()}, {"name": "endDate", "value": $('#endDate').val()});
            }
        });
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#csvexport").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "../../csv_stock_detail.php",
                data: {stock_id: $("#stock_id").val(), endDate: $("#endDate").val()},
                cache: false,
                dataType: 'html',
                success: function(data) {
                    window.open('../../csv_stock_detail.php?stock_id=' + stock_id + '&endDate=' + endate);
                }
            });
        });
        ////////////////////////////////////////////////////////////////////////////////
...
<div class="itemslist">
    ...
    <h1 class="items-head list-page"><img src="<?php echo sfConfig::get('app_web_url') . 'images/sale_over.png' ?>" />&nbsp;Stock Detail Reports (Stock# <?php echo $stock->getStockId();  ?>)</h1>
