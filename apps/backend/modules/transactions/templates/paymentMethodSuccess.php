...
var oTable= $('#myTable').dataTable({
            ...
            "bFilter": false,
            "bInfo": false,
            "sAjaxSource": "<?php echo sfConfig::get('app_web_url') ?>server_payment_method_report.php",
...
$.ajax({
  type: "POST",
  url: "../../csv_payment_method.php",
  data: {startDate:$("#startDate").val()  ,endDate:$("#endDate").val()},
  cache: false,
   dataType: 'html',
  success: function(data){
      window.open('../../csv_payment_method.php?startDate='+ stdate +'&endDate='+endate);
  }
});
});
 ////////////////////////////////////////////////////////////////////////////////
...
<div class="itemslist">
    ...
    <h1 class="items-head list-page"><img src="<?php echo sfConfig::get('app_web_url') . 'images/sale_over.png' ?>" />&nbsp;Payment Method Reports</h1>
