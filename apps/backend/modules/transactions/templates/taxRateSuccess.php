...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        var oTable = $('#myTable').dataTable({
            ...
            "bFilter": false,
            "bInfo": false,
            "sAjaxSource": "<?php echo sfConfig::get('app_web_url') ?>server_tax_rate_report.php",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#csvexport").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "../../csv_tax_rate.php",
                data: {startDate: $("#startDate").val(), endDate: $("#endDate").val()},
                cache: false,
                dataType: 'html',
                success: function(data) {
                    window.open('../../csv_tax_rate.php?startDate=' + stdate + '&endDate=' + endate);
                }
            });
        });
        ////////////////////////////////////////////////////////////////////////////////
...
<div class="itemslist">
    ...
    <h1 class="items-head list-page"><img src="<?php echo sfConfig::get('app_web_url') . 'images/sale_over.png' ?>" />&nbsp;Tax Rate Reports</h1>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered itemlistTable" id="myTable" >
            <thead>
                <tr>
                    <th>Tax</th>
                    <th>Rate</th>
                    <th> Vat Amount On Paid Order</th>
                     <th>Paid Order Amount</th>
                </tr>
            </thead>
            <tbody>
