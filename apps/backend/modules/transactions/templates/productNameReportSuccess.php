...
var oTable= $('#myTable').dataTable({
            ...
            "bFilter": false,
            "bInfo": true,
            "sAjaxSource": "<?php echo sfConfig::get('app_web_url') ?>server_productNameReport.php",
...
$.ajax({
  type: "POST",
  url: "../../report_prodcut_name_sale.php",
  data: {startDate:$("#startDate").val()  ,endDate:$("#endDate").val()},
  cache: false,
   dataType: 'html',
  success: function(data){
      window.open('../../report_prodcut_name_sale.php?startDate='+ stdate +'&endDate='+endate);
  }
});
});
 ////////////////////////////////////////////////////////////////////////////////
