...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        var oTable = $('#myTable').dataTable({
            ...
            "bFilter": false,
            "bInfo": false,
            "sAjaxSource": "<?php echo sfConfig::get('app_web_url') ?>server_staff_sale_report.php",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#csvexport").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "../../csv_staff_sale.php",
                data: {startDate: $("#startDate").val(), endDate: $("#endDate").val()},
                cache: false,
                dataType: 'html',
                success: function(data) {
                    window.open('../../csv_staff_sale.php?startDate=' + stdate + '&endDate=' + endate);
                }
            });
        });
        ////////////////////////////////////////////////////////////////////////////////
...
<div class="itemslist">
    ...
    <h1 class="items-head list-page"><img src="<?php echo sfConfig::get('app_web_url') . 'images/sale_over.png' ?>" />&nbsp;Reports / Orders – Staff </h1>
