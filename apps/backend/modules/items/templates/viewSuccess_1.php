...
<script type="text/javascript">
 ...
 ///////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////  
    ...
    $('#myTableItemImageHistry').dataTable( {
      
        "bProcessing": true,
	"bServerSide": true,
        "bFilter": false,
	"sAjaxSource": "<?php echo sfConfig::get('app_web_url')?>server_item_image_history.php",
        "sPaginationType": "full_numbers",
         "sDom": "<'paging'<'span6'l><'span6'f>r>t<'paging'<'span6'i><'span6'p>>",
         "fnServerParams": function ( aoData ) {
    aoData.push({ "name": "item_id", "value": $("#itemId").val() });
  ...
  $.datepicker.regional[""].dateFormat = 'yy-mm-dd 00:00:00';
	...
	"bServerSide": true,
        "bFilter": false,
	"sAjaxSource": "<?php echo sfConfig::get('app_web_url')?>server_item_byshop_sales.php",
        "sPaginationType": "full_numbers",
         "sDom": "<'paging'<'span6'l><'span6'f>r>t<'paging'<'span6'i><'span6'p>>",
          "fnServerParams": function ( aoData ) {
    aoData.push({ "name": "item_id", "value": $("#itemId").val() });
...
<div class="regForm" style="padding-top:47px;">  <br />
    ...
    <div class="itemsfields">  
        ...
        <div class="right">
            <div class="inputValue ean"><?php // echo $item->getEan();
          //  echo $barcode;
//          $bc = new barCode('png');
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered historyTbl" id="myTableItem" >
 ...
 <tbody> 
  ...
  <br clear="all" />
<h1 class="items-head" id="image-head"><img src="<?php echo sfConfig::get('app_web_url').'images/items_over.png'?>" />&nbsp;Item Image History

</h1>
<div class="regForm" id="image-history-block">
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="myTableItemImageHistry" >
 <thead>
      <tr >  
          <th>Item Image  </th> <th>Updated At</th>   <th>Updated By</th>  
    </tr>
 </thead>
 <tbody>  
