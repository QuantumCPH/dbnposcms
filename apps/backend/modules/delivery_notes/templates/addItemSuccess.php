...
<div class="popupdiv" style="background-color:#fff;">
    <form method="post" name="frmAddItem" id="frmAddItem" action="<?php echo url_for("delivery_notes/saveItem")?>">
...
<!--        <button type="button" class="close" onclick="$.fn.custombox('close');"><img src="<?php echo sfConfig::get("app_web_url")?>images/popup-close.png" /></button>-->
    ...
    <div class="lblright">
        <div class="col-lg-6">
            <input type="text" name="itemnum" autocomplete="off"  class="form-control itemsid required digits" />
        </div>
    </div> 
    <br clear="all" />    
