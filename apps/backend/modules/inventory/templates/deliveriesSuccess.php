...
<script type="text/javascript">
    ...
    $('#myTable').dataTable( {
        ...
        "bProcessing": true,
	"bServerSide": true,
	"sAjaxSource": "<?php echo sfConfig::get('app_web_url')?>server_inventoryDeliveries.php",
    ...
    aoData.push({ "name": "branch_number", "value": $("#branch_number").val() },{ "name": "item_id", "value": $("#itemId").val() });
}
...
<h1 class="items-head list-page">Item Delivery Detail&nbsp; for <img src="<?php echo sfConfig::get('app_web_url').'images/inventory_over.png'?>" />&nbsp;Branch # <?php echo $branch_number;  ?>  and <img src="<?php echo sfConfig::get('app_web_url').'images/items_over.png'?>" />&nbsp;&nbsp;Item #<?php echo $item_id;  ?></h1>
