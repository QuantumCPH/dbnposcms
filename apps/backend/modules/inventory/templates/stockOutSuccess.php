...
<script type="text/javascript">
    ...
    $('#myTable').dataTable( {
        ...
        "bProcessing": true,
	"bServerSide": true,
	"sAjaxSource": "<?php echo sfConfig::get('app_web_url')?>server_inventoryStockOut.php",
...
<h1 class="items-head list-page">Item StockOut &nbsp; for <img src="<?php echo sfConfig::get('app_web_url').'images/inventory_over.png'?>" />&nbsp;Branch # <?php echo $branch_number;  ?> &nbsp; and &nbsp;<img src="<?php echo sfConfig::get('app_web_url').'images/items_over.png'?>" />&nbsp;&nbsp;Item #<?php echo $item_id;  ?></h1>
