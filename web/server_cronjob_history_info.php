 ...
 */
$aColumns = array("xml", "csv", "status", "message","created_at" );

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "id";

/* DB table to use */
$sTable = "cron_job_history_info";
...
if ($sWhere == "") {
            $sWhere = "WHERE   cron_job_history_id='".$_GET['history_id']."'" ;
        } else {
            $sWhere .= " AND     cron_job_history_id='".$_GET['history_id']."'" ;
        }
