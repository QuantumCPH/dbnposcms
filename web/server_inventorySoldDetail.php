...
//
 if ($sWhere == "") {
            $sWhere = "WHERE  transactions.transaction_type_id<>1 AND transactions.status_id=3 AND shops.branch_number=".$_GET['branch_number']."  AND transactions.item_id='".$_GET['item_id']."'" ;
        } else {
            $sWhere .= " AND  transactions.transaction_type_id<>1 AND transactions.status_id=3  AND shops.branch_number=".$_GET['branch_number']."  AND transactions.item_id='".$_GET['item_id']."'" ;
        }
