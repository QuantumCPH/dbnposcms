 ...
 */
$aColumns = array('items_log.id','items_log.description1', 'items_log.description2', 'items_log.description3', 'items_log.supplier_number', 'items_log.supplier_item_number', 'items_log.group', 'items_log.color', 'items_log.size', 'items_log.buying_price', 'items_log.selling_price','items_log.taxation_code','items_log.item_status_id','items_log.updated_at','user.name');
...
//          if ($aColumns[$i] == "items_log.item_status_id") {
//            $status_id = $aRow[$col[1]];
//            $status = "";
//            if($status_id == 3){
//                $status = "Active";
//            }elseif($status_id == 5){
