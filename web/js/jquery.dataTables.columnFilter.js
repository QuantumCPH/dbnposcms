...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text"   placeholder="From date"  class="date_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker({ dateFormat: 'yy-mm-dd 00:00:00' });
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text"  placeholder="To date" class="date_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
            ...
            th.wrapInner('<span class="filter_column filter_date_range form-inline" />');
